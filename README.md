...
Este laboratório fornece um ambiente leve e isolado para testar automações com **Ansible** utilizando containers Docker. Ele consiste em um controlador e dois nós-alvo (nodes), todos baseados em Ubuntu 22.04.
